...
import { SiZapier, SiSalesforce, SiHubspot, SiN8N, SiMailchimp } from "react-icons/si";
import { nameToSlugMap } from "@/data/platforms";
import AnimatedCounter from "@/components/AnimatedCounter";
import CTA from "@/components/CTA";
import ServicePortfolio from "@/components/ServicePortfolio";

import highLevelLogo from "@/assets/highlevel-service.webp";
import powerautomateLogo from "@/assets/powerautomate-logo.webp";
import serviceTechBg from "@/assets/bg-ai-automations.webp";
import { usePageMeta } from "@/hooks/use-page-meta";

const platforms = [
  { icon: () => <img src={highLevelLogo} alt="GoHighLevel" className="w-6 h-6 object-contain" />, name: "GoHighLevel", color: "#242424", slug: "gohighlevel" },
  { icon: SiZapier, name: "Zapier", color: "#FF4A00", slug: "zapier" },
  { icon: SiN8N, name: "n8n", color: "#FF6D5A", slug: "n8n" },
  { icon: () => <img src={powerautomateLogo} alt="Power Automate" className="w-6 h-6 object-contain" />, name: "Power Automate", color: "#0066FF", slug: "power-automate" },
  { icon: SiSalesforce, name: "Salesforce", color: "#00A1E0", slug: "salesforce" },
  { icon: SiHubspot, name: "HubSpot", color: "#FF7A59", slug: "hubspot" },
  { icon: SiMailchimp, name: "Mailchimp", color: "#FFE01B", slug: "mailchimp" },
];
...
const features = [
  {
    ...
    description: "Automated workflows tailored to your business processes."
  },
  {
    icon: Link2,
    title: "1000+ Integrations",
    description: "Connect all your tools and apps for seamless data flow."
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    description: "Automated email sequences that engage and convert."
  },
  {
    icon: BarChart3,
  ...
  },
  {
    icon: Clock,
    title: "Time Savings",
    description: "Reduce manual tasks by up to 80% with smart automation."
  }
];
...
const services = [
  ...
  "Multi-platform AI integrations (1000+ apps)",
...
const benefits = [
  ...
  { value: "340%", label: "Efficiency Boost", description: "In lead management" },
  { value: "50+", label: "Integrations", description: "Connected apps" },
  { value: "24/7", label: "Automation", description: "Always working" }
];
...
export default function CRMAutomationPage() {
  usePageMeta("services/ai-automation");
  ...
  return (
    <div className="relative pt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Harness the power of AI to automate your business operations. We build intelligent automation solutions using AI-powered tools, CRM integrations, and smart workflows to boost productivity.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {benefits.map((benefit, idx) => {
              ...
              const isStatic = benefit.value === "24/7";
              const numValue = isStatic ? 0 : parseInt(benefit.value);
              const suffix = isStatic ? "" : benefit.value.replace(/[0-9]/g, '');
              ...
              return (
                ...
                >
                  <div className="text-4xl font-bold text-primary mb-2">
                    {isStatic ? benefit.value : <AnimatedCounter value={numValue} suffix={suffix} inView={isBenefitInView} />}
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-8">
                Complete AI Automation <span className="text-primary">Solutions</span>
              </h2>
            ...
            >
              <h3 className="text-xl font-bold mb-6">How AI Automation Helps</h3>
              <div className="space-y-6">
                <div className="flex gap-4 items-start">
                  <Target className="w-6 h-6 text-primary shrink-0" />
                  <div>
                    <h4 className="font-semibold mb-1">Lead Capture</h4>
                    <p className="text-sm text-muted-foreground">Automatically capture leads from multiple sources into your CRM</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  <Mail className="w-6 h-6 text-primary shrink-0" />
                  <div>
                    <h4 className="font-semibold mb-1">Nurture Sequences</h4>
                    <p className="text-sm text-muted-foreground">Automated email and SMS sequences to engage leads</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  <TrendingUp className="w-6 h-6 text-primary shrink-0" />
                  <div>
                    <h4 className="font-semibold mb-1">Sales Pipeline</h4>
                    <p className="text-sm text-muted-foreground">Move leads through your pipeline automatically based on actions</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Get automated reports on your business performance</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <ServicePortfolio category="AI Automation" />
      <CTA />
      </div>
    </div>
  );
