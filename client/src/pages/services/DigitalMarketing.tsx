...
import { SiGoogle, SiFacebook, SiInstagram, SiYoutube, SiTiktok, SiLinkedin } from "react-icons/si";
import { nameToSlugMap } from "@/data/platforms";
import AnimatedCounter from "@/components/AnimatedCounter";
import CTA from "@/components/CTA";
import ServicePortfolio from "@/components/ServicePortfolio";
import serviceTechBg from "@/assets/bg-digital-marketing.webp";
import { usePageMeta } from "@/hooks/use-page-meta";

const platforms = [
  { icon: SiGoogle, name: "Google Ads", color: "#4285F4", slug: "google-ads" },
  { icon: SiFacebook, name: "Facebook Ads", color: "#1877F2", slug: "facebook-ads" },
  { icon: SiInstagram, name: "Instagram Ads", color: "#E4405F", slug: "instagram-ads" },
  { icon: SiYoutube, name: "YouTube Ads", color: "#FF0000", slug: "youtube-ads" },
  { icon: SiTiktok, name: "TikTok Ads", color: "#000000", slug: "tiktok" },
  { icon: SiLinkedin, name: "LinkedIn Ads", color: "#0A66C2", slug: "linkedin" },
];
...
const features = [
  {
    ...
    description: "Reach your ideal customers with laser-focused audience targeting."
  },
  {
    icon: TrendingUp,
    title: "Conversion Tracking",
    description: "Track every conversion and optimize for maximum ROI."
  },
  {
    icon: BarChart3,
    title: "ROI Analytics",
    description: "Detailed reports showing your return on ad spend."
  },
  {
    icon: DollarSign,
    title: "Budget Optimization",
    description: "Make every dollar count with smart budget allocation."
  },
  {
    icon: Eye,
    title: "Retargeting",
  ...
  },
  {
    icon: Zap,
    title: "A/B Testing",
    description: "Continuous testing to improve ad performance."
  }
];
...
const results = [
  { value: "500%", label: "Average ROAS", description: "Return on ad spend" },
  { value: "65%", label: "Lower CPA", description: "Cost per acquisition" },
  { value: "3x", label: "More Leads", description: "Than organic alone" },
  { value: "24/7", label: "Campaign Monitoring", description: "Always optimizing" }
];
...
export default function DigitalMarketingPage() {
  usePageMeta("services/digital-marketing");
  ...
  return (
    <div className="relative pt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                High-performing advertising campaigns that deliver measurable ROI. We create and manage targeted ad campaigns across Google, Facebook, Instagram, and more to grow your business.
              </p>
            ...
            >
              <div className="relative p-8 rounded-3xl bg-white border border-gray-100 shadow-xl">
                ...
                <h3 className="text-xl font-bold mb-6">Advertising Platforms</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-8">
                Complete Advertising <span className="text-primary">Solutions</span>
              </h2>
            ...
            >
              <h3 className="text-xl font-bold mb-6">Our Campaign Process</h3>
              <div className="space-y-6">
                <div className="flex gap-4 items-start">
                  <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center text-primary font-bold">1</div>
                  <div>
                    <h4 className="font-semibold mb-1">Strategy & Research</h4>
                    <p className="text-sm text-muted-foreground">Understanding your goals and researching your audience</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center text-primary font-bold">2</div>
                  <div>
                    <h4 className="font-semibold mb-1">Campaign Setup</h4>
                    <p className="text-sm text-muted-foreground">Creating ads, targeting, and conversion tracking</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h4 className="font-semibold mb-1">Optimize & Scale</h4>
                    <p className="text-sm text-muted-foreground">Continuous optimization for maximum ROI</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <ServicePortfolio category="Digital Marketing" />
      <CTA />
      </div>
    </div>
  );
