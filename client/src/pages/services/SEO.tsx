...
import { SiGoogle, SiSemrush, SiWordpress } from "react-icons/si";
import { nameToSlugMap } from "@/data/platforms";
import AnimatedCounter from "@/components/AnimatedCounter";
import CTA from "@/components/CTA";
import ServicePortfolio from "@/components/ServicePortfolio";
import serviceTechBg from "@/assets/bg-seo-geo.webp";
import { usePageMeta } from "@/hooks/use-page-meta";

const platforms = [
  { icon: () => <img src={googleAnalyticsLogo} alt="Google Analytics" className="w-6 h-6 object-contain" />, name: "Google Analytics", color: "#F4B400", slug: "google" },
  { icon: () => <img src={googleSearchConsoleLogo} alt="Google Search Console" className="w-6 h-6 object-contain" />, name: "Google Search Console", color: "#4285F4", slug: "google" },
  { icon: SiSemrush, name: "SEMrush", color: "#FF642D", slug: "semrush" },
  { icon: () => <img src={ahrefsLogo} alt="Ahrefs" className="w-6 h-6 object-contain" />, name: "Ahrefs", color: "#FF6B35", slug: "ahrefs" },
];
...
const features = [
  ...
  },
  {
    icon: FileText,
    title: "On-Page SEO",
    description: "Content optimization, meta tags, headings, and internal linking structure."
  },
  {
    icon: Link2,
    title: "Off-Page SEO",
    description: "Quality backlink building, brand mentions, and authority development."
  },
  {
    icon: Target,
    title: "Keyword Research",
    description: "Data-driven keyword strategy to target high-value search terms."
  },
  {
    icon: BarChart3,
    title: "Competitor Analysis",
    description: "In-depth analysis of competitors to identify opportunities."
  },
  {
    icon: LineChart,
    title: "Ranking Reports",
    description: "Regular reporting on rankings, traffic, and SEO performance."
  }
];
...
const results = [
  { value: "200%", label: "Average Traffic Increase", description: "Within 6 months" },
  { value: "Top 10", label: "Keyword Rankings", description: "For targeted terms" },
  { value: "252+", label: "Projects Completed", description: "Across industries" },
...
export default function SEOPage() {
  usePageMeta("services/seo-and-geo");
  ...
  return (
    <div className="relative pt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Data-driven SEO and GEO (Generative Engine Optimization) strategies that improve your rankings across search engines and AI-powered platforms. We optimize every aspect of your digital presence.
              </p>
                ...
                <div className="grid grid-cols-3 gap-4">
                  {platforms.map((platform, index) => (
                    ...
                    >
                      ...
                      <span className="text-[10px] text-muted-foreground mt-2 opacity-0 group-hover:opacity-100 transition-opacity text-center whitespace-nowrap">
                        {platform.name}
                      </span>
                    </motion.div>
                  ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-8">
                Complete SEO <span className="text-primary">Solutions</span>
              </h2>
            ...
            >
              <h3 className="text-xl font-bold mb-6">Our SEO Process</h3>
              <div className="space-y-6">
                <div className="flex gap-4 items-start">
                  <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center text-primary font-bold">1</div>
                  <div>
                    <h4 className="font-semibold mb-1">Audit & Analysis</h4>
                    <p className="text-sm text-muted-foreground">Complete website audit and competitor research</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Custom SEO strategy based on your goals</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">On-page, off-page, and technical optimizations</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center text-primary font-bold">4</div>
                  <div>
                    <h4 className="font-semibold mb-1">Monitor & Report</h4>
                    <p className="text-sm text-muted-foreground">Track rankings and provide detailed reports</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <ServicePortfolio category="SEO & GEO" />
      <CTA />
      </div>
    </div>
  );
